...
class AswanBanksScreen extends StatefulWidget {
  const AswanBanksScreen({Key? key});

  @override
  State<AswanBanksScreen> createState() => _AswanBanksScreenState();
}
...
class PlaceAPI {
  ...
  Future<List<BankModel>> getAllTrips() async {
    ...
    try {
      Response response = await dio.get('${baseUrl}api/user/bank/aswan');
...
class _AswanBanksScreenState extends State<AswanBanksScreen> {
