...
class RedSeaBanksScreen extends StatefulWidget {
  ...
  @override
  State<RedSeaBanksScreen> createState() => _RedSeaBanksScreenState();
}
...
class PlaceAPI {
  ...
  Future<List<BankModel>> getAllTrips() async {
    ...
    try {
      Response response = await dio.get('${baseUrl}api/user/bank/red-sea');
...
class _RedSeaBanksScreenState extends State<RedSeaBanksScreen> {
