...
class AlexRestaurantsScreen extends StatefulWidget {
  const AlexRestaurantsScreen({Key? key});

  @override
  State<AlexRestaurantsScreen> createState() => _AlexRestaurantsScreenState();
}
...
class PlaceAPI {
  ...
  Future<List<RestaurantsModel>> getAllTrips() async {
    ...
    try {
      Response response = await dio.get('${baseUrl}api/user/resturant/Alexandria');
...
class _AlexRestaurantsScreenState extends State<AlexRestaurantsScreen> {
