...
class AlexBanksScreen extends StatefulWidget {
  const AlexBanksScreen({Key? key});

  @override
  State<AlexBanksScreen> createState() => _AlexBanksScreenState();
}
...
class PlaceAPI {
  ...
  Future<List<BankModel>> getAllTrips() async {
    ...
    try {
      Response response = await dio.get('${baseUrl}api/user/bank/Alexandria');
...
class _AlexBanksScreenState extends State<AlexBanksScreen> {
