...
class CairoBanksScreen extends StatefulWidget {
  ...
  @override
  State<CairoBanksScreen> createState() => _CairoBanksScreenState();
}
...
class PlaceAPI {
  ...
  Future<List<BankModel>> getAllTrips() async {
    ...
    try {
      Response response = await dio.get('${baseUrl}api/user/bank/cairo');
...
class _CairoBanksScreenState extends State<CairoBanksScreen> {
